    ...
    return (
      <div className={isDark ? "dark" : "light"}>
        <main className="min-h-screen overflow-x-hidden">
          {children}
          {currentPage !== "dashboard" && currentPage !== "organic-visuals" && currentPage !== "bio-proteins" && currentPage !== "inorganic-visuals" && currentPage !== "inorganic-deep-module" && currentPage !== "inorganic-crystals" && (
            <>

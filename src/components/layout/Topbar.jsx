...
const parentCrumbs = {
  ...
  'atom-builder': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'atom-builder', label: 'Build an Atom' }],
  'gas-properties': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'gas-properties', label: 'Gas Properties' }],
  'reaction-leftovers': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'reaction-leftovers', label: 'Reactants and Leftovers' }],
  'acid-base-solutions': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'acid-base-solutions', label: 'Acid-Base Solutions' }],
  'molecule-polarity': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'molecule-polarity', label: 'Molecule Polarity' }],
  'molecules-light': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'molecules-light', label: 'Molecules and Light' }],
  'states-matter': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'states-matter', label: 'States of Matter' }],
  ...
  syllabus: [{ id: 'dashboard', label: 'Dashboard' }, { id: 'syllabus', label: 'Learning Path' }],
  ...
  'structure-draw': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'structure-draw', label: 'Structure Draw' }],
  ...
  'advanced-visuals': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'subject-modules', label: 'Subject Modules' }, { id: 'advanced-visuals', label: 'Advanced Visuals' }],
  'practice-tutor': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'subject-modules', label: 'Subject Modules' }, { id: 'practice-tutor', label: 'Practice Tutor' }],
  'learning-command': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'subject-modules', label: 'Subject Modules' }, { id: 'learning-command', label: 'Command Center' }],
  'coverage-audit': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'subject-modules', label: 'Subject Modules' }, { id: 'coverage-audit', label: 'Curriculum Map' }],
  'research-toolkit': [{ id: 'dashboard', label: 'Dashboard' }, { id: 'subject-modules', label: 'Subject Modules' }, { id: 'research-toolkit', label: 'Research Toolkit' }],

...
export const virtualLabCoverage = [
  { id: 'physical-chemistry-vl', category: 'elements', title: 'Physical Chemistry Virtual Lab', sourceUrl: 'https://vlab.amrita.edu/?sub=2&brch=190', experiments: [
    ['Spectrophotometry', 'covered'], ['Cryoscopy', 'covered'], ['Ebullioscopy', 'covered'], ['EMF Measurement', 'covered'], ['Determination of Viscosity of Organic Solvents', 'covered'], ['Adsorption Isotherm', 'covered'], ['Verification of Tafel Equation', 'covered'], ['Viscosity-Average Molecular Weight of Polymer', 'covered'], ['Calorimetry – Water Equivalent Calorimetry', 'covered'], ['Calorimetry – Heat of Neutralization', 'covered'],
  ] },
  { id: 'organic-chemistry-vl', category: 'organic', title: 'Organic Chemistry Virtual Lab', sourceUrl: 'https://vlab.amrita.edu/?sub=2&brch=191', experiments: [
    ['Detection of Functional Groups', 'covered'], ['Detection of Elements: Lassaigne’s Test', 'covered'], ['Separation of Compounds Using Column Chromatography', 'covered'], ['Purification by Fractional Distillation/Crystallisation', 'covered'], ['Purification by Steam Distillation/Crystallisation', 'covered'], ['Laser Flash Photometer', 'covered'], ['Organic Preparations – Allylation of Isatin', 'covered'], ['Bromination of Phenol and Aniline', 'covered'], ['Benzoylation of Aniline and Phenol', 'covered'], ['Estimation of Aspirin', 'covered'], ['Estimation of Glucose', 'covered'], ['Calculation of λmax Using Woodward–Fieser Rules', 'covered'],
  ] },
  ...
  { id: 'advanced-analytical-chemistry-vl', category: 'analytical', title: 'Advanced Analytical Chemistry Virtual Lab', sourceUrl: 'https://vlab.amrita.edu/?sub=2&brch=294', experiments: [
    ['Soil Analysis – Available Organic Carbon', 'covered'], ['Soil Analysis – Available Nitrogen (Kjeldahl)', 'covered'], ['Soil Analysis – Available Phosphorus (Bray)', 'covered'], ['Electrogravimetric Estimation of Metals', 'covered'], ['Estimation of Phosphate Content in Soft Drinks', 'covered'], ['Flame Photometry', 'covered'], ['Polarography – Unknown Cadmium Concentration', 'covered'], ['Polarography – Unknown Vitamin C Concentration', 'covered'],
  ] },
];

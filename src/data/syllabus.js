...
export const labToolCatalog = [
  ...
  { id: 'analytical-lab', title: 'Full Analytical Chemistry Lab', type: 'Simulation', tracks: ['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma', 'medicalChem'], units: ['practical', 'solutions', 'inorganic', 'clinical', 'pharmaceutical'] },
  ...
  { id: 'surface-chemistry-deep', title: 'Surface Chemistry Deep Module', type: 'Simulation', tracks: ['class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma'], units: ['solutions', 'kinetics', 'practical', 'pharmaceutical'] },
  ...
  { id: 'organic-reaction-bank', title: 'Organic Reaction Bank Depth', type: 'Practice', tracks: ['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma'], units: ['organicBasics', 'organicAdvanced', 'practical', 'pharmaceutical'] },
  ...
  { id: 'environmental-chem', title: 'Environmental Chemistry Deep Module', type: 'Simulation', tracks: ['class11', 'class12', 'neet', 'jeeMain'], units: ['environmental', 'airWater', 'solutions', 'practical'] },
  ...
  { id: 'salt-analysis', title: 'Full Qualitative Salt Analysis Simulator', type: 'Practice', tracks: ['class10', 'class11', 'class12', 'neet', 'jeeMain'], units: ['inorganic', 'practical'] },
  ...
  { id: 'nuclear-chemistry', title: 'Nuclear Chemistry Lab', type: 'Simulation', tracks: ['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'medicalChem'], units: ['atoms', 'thermo', 'clinical'] },
...
export const labSyllabusTags = {
  ...
  'analytical-lab': tags(['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma', 'medicalChem'], ['practical', 'solutions', 'inorganic', 'clinical', 'pharmaceutical']),
  'organic-solvent-viscosity': tags(['class11', 'class12', 'jeeMain', 'jeeAdvanced', 'pharma'], ['practical', 'solutions']),
  'laser-flash-photometry': tags(['class12', 'jeeAdvanced', 'pharma', 'medicalChem'], ['practical', 'kinetics', 'pharmaceutical']),
  'aspirin-estimation': tags(['class12', 'pharma', 'medicalChem'], ['practical', 'organicAdvanced', 'pharmaceutical']),
  'glucose-estimation': tags(['class12', 'neet', 'pharma', 'medicalChem'], ['practical', 'biomolecules', 'clinical']),
  'water-physical-analysis': tags(['class8', 'class9', 'class10', 'class11', 'class12', 'pharma'], ['airWater', 'environmental', 'practical']),
  'water-chemical-analysis': tags(['class10', 'class11', 'class12', 'neet', 'pharma'], ['airWater', 'environmental', 'solutions', 'practical']),
  'gravimetric-barium': tags(['class11', 'class12', 'jeeAdvanced', 'pharma'], ['inorganic', 'practical']),
  'gravimetric-nickel': tags(['class11', 'class12', 'jeeAdvanced', 'pharma'], ['coordination', 'inorganic', 'practical']),
  'brass-alloy-analysis': tags(['class10', 'class11', 'class12', 'jeeMain', 'pharma'], ['inorganic', 'redox', 'practical']),
  'soil-conductivity': tags(['class9', 'class10', 'class11', 'class12'], ['environmental', 'solutions', 'practical']),
  'soil-ph': tags(['class8', 'class9', 'class10', 'class11', 'class12'], ['acidBase', 'environmental', 'practical']),
  'soil-organic-carbon': tags(['class11', 'class12', 'pharma'], ['environmental', 'redox', 'practical']),
  'soil-nitrogen-kjeldahl': tags(['class11', 'class12', 'pharma'], ['environmental', 'practical']),
  'soil-phosphorus-bray': tags(['class11', 'class12', 'pharma'], ['environmental', 'solutions', 'practical']),
  'soft-drink-phosphate': tags(['class11', 'class12', 'pharma'], ['solutions', 'practical']),
  'flame-photometry': tags(['class11', 'class12', 'neet', 'jeeMain', 'pharma'], ['atoms', 'practical', 'clinical']),
  'polarography-cadmium': tags(['class12', 'jeeAdvanced', 'pharma'], ['electrochem', 'environmental', 'practical']),
  'polarography-vitamin-c': tags(['class12', 'neet', 'pharma', 'medicalChem'], ['electrochem', 'biomolecules', 'practical', 'clinical']),
  'glass-working-assessment': tags(['class6', 'class7', 'class8', 'class9', 'class10', 'class11', 'class12'], ['practical', 'materials']),
  'physical-constant-assessment': tags(['class9', 'class10', 'class11', 'class12', 'neet', 'jeeMain', 'pharma'], ['practical', 'matter', 'organicBasics']),
  'quantitative-technique-assessment': tags(['class9', 'class10', 'class11', 'class12', 'neet', 'jeeMain', 'pharma'], ['practical', 'mole', 'solutions']),
  'common-ion-assessment': tags(['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma'], ['equilibrium', 'acidBase', 'solutions', 'practical']),
  'titration-mastery-assessment': tags(['class10', 'class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma'], ['acidBase', 'redox', 'coordination', 'solutions', 'practical']),
  'qualitative-ion-case-assessment': tags(['class10', 'class11', 'class12', 'neet', 'jeeMain', 'pharma'], ['inorganic', 'coordination', 'practical']),
  'organic-element-detection-assessment': tags(['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma'], ['organicBasics', 'organicAdvanced', 'practical']),
  'colloid-techniques-assessment': tags(['class9', 'class10', 'class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma'], ['solutions', 'practical']),
  'kinetics-clock-assessment': tags(['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma'], ['kinetics', 'practical']),
  'enthalpy-practicals-assessment': tags(['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma'], ['thermo', 'solutions', 'practical']),
  'paper-chromatography-assessment': tags(['class9', 'class10', 'class11', 'class12', 'neet', 'jeeMain', 'pharma'], ['separation', 'organicBasics', 'biomolecules', 'practical']),
  'inorganic-preparation-assessment': tags(['class11', 'class12', 'jeeMain', 'jeeAdvanced', 'pharma'], ['inorganic', 'coordination', 'practical']),
  'organic-preparation-assessment': tags(['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma'], ['organicAdvanced', 'practical', 'pharmaceutical']),
  'food-biochemical-tests-assessment': tags(['class9', 'class10', 'class11', 'class12', 'neet', 'pharma', 'medicalChem'], ['biomolecules', 'clinical', 'practical']),
  'project-record-viva-assessment': tags(['class9', 'class10', 'class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma', 'medicalChem'], ['practical']),
  ...
  'surface-chemistry-deep': tags(['class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma'], ['solutions', 'kinetics', 'practical', 'pharmaceutical']),
  'named-reactions': tags(['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced'], ['organicAdvanced', 'coordination']),
  'organic-reaction-bank': tags(['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'pharma'], ['organicBasics', 'organicAdvanced', 'practical', 'pharmaceutical']),
  ...
  'environmental-chem': tags(['class11', 'class12', 'neet', 'jeeMain'], ['environmental', 'airWater', 'solutions', 'practical']),
  ...
  'nuclear-chemistry': tags(['class11', 'class12', 'neet', 'jeeMain', 'jeeAdvanced', 'medicalChem'], ['atoms', 'thermo', 'clinical']),
